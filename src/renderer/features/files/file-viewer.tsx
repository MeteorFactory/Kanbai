            ...
            beforeMount={(monaco) => {
              monaco.editor.defineTheme('catppuccin-mocha', {
                ...
                colors: {
                  ...
                  'editorBracketMatch.background': '#1F2328',
                  'editorBracketMatch.border': '#6C8CFF',
                  'editorIndentGuide.background': '#1A1D2280',
                  'editorIndentGuide.activeBackground': '#1F2328',
                  'editorWhitespace.foreground': '#1A1D2280',
                  'editor.findMatchBackground': '#fbbf2440',
                  'editor.findMatchHighlightBackground': '#fbbf2420',
                  'editorGutter.background': '#0B0D0F',
                  'scrollbar.shadow': '#0F1114',
                  'scrollbarSlider.background': '#1F232880',
                  'scrollbarSlider.hoverBackground': '#585b70',
                  'scrollbarSlider.activeBackground': '#565C66',
                },
              })
            }}
            options={{

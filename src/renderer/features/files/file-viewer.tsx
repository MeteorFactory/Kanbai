            ...
            beforeMount={(monaco) => {
              monaco.editor.defineTheme('catppuccin-mocha', {
                ...
                rules: [
                  ...
                  { token: 'type.identifier', foreground: '6C8CFF' },
                  { token: 'function', foreground: '6C8CFF' },
                  { token: 'variable', foreground: 'F0F2F4' },
                  { token: 'variable.predefined', foreground: 'F47067' },
                  ...
                  { token: 'string.key.json', foreground: '6C8CFF' },
                  { token: 'string.value.json', foreground: '3DD68C' },
                  { token: 'number.json', foreground: 'F5A623' },
                  { token: 'keyword.json', foreground: 'F5A623' },
                  { token: 'delimiter.bracket.json', foreground: 'fbbf24' },
                  { token: 'delimiter.colon.json', foreground: '9399b2' },
                  { token: 'delimiter.comma.json', foreground: '9399b2' },
                  { token: 'tag', foreground: 'F47067' },
                  { token: 'tag.id', foreground: 'F47067' },
                  { token: 'tag.class', foreground: 'F47067' },
                  { token: 'attribute.name', foreground: 'fbbf24' },
                  { token: 'attribute.value', foreground: '3DD68C' },
                  { token: 'selector', foreground: 'a78bfa' },
                  { token: 'property', foreground: '6C8CFF' },
                  { token: 'markup.heading', foreground: 'F47067', fontStyle: 'bold' },
                  { token: 'markup.bold', foreground: 'F5A623', fontStyle: 'bold' },
                  { token: 'markup.italic', foreground: 'ec4899', fontStyle: 'italic' },
                  { token: 'markup.inline', foreground: '3DD68C' },
                  { token: 'meta.content', foreground: 'F0F2F4' },
                ],
                colors: {
                  ...
                  'editorBracketMatch.background': '#201F1C',
                  'editorBracketMatch.border': '#9747FF',
                  'editorIndentGuide.background': '#201F1C80',
                  'editorIndentGuide.activeBackground': '#201F1C',
                  'editorWhitespace.foreground': '#201F1C80',
                  'editor.findMatchBackground': '#fbbf2440',
                  'editor.findMatchHighlightBackground': '#fbbf2420',
                  'editorGutter.background': '#0E0D0B',
                  'scrollbar.shadow': '#181715',
                  'scrollbarSlider.background': '#201F1C80',
                  'scrollbarSlider.hoverBackground': '#585b70',
                  'scrollbarSlider.activeBackground': '#6B6A65',
                },
              })
            }}
            options={{
